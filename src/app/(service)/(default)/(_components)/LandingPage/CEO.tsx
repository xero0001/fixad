      ...
      <div className="mt-16 grid grid-template lg:grid-cols-[3fr_3fr]">
        ...
        <div className="lg:border-r-2 border-l-black border-r-black w-full">
          ...
          <div className="py-12 pt-10 lg:py-4 lg:px-12">
            ...
            <h5 className="text-2xl mt-3">{t(LS.position, lang)}</h5>
        ...
        <div className="lg:pl-12">
          ...
          <div className="py-8 lg:py-4">
            <h3 className="text-3xl lg:text-4xl">{t(LS.ideology, lang)}</h3>
            <p className="text-base lg:text-lg mt-4">
              {t(LS.companyIdeology1, lang)}
              <br />
              <br />
              {t(LS.companyIdeology2, lang)}
              <br />
              <br />
              {t(LS.companyIdeology3, lang)}
              <br />
              <br />
              {t(LS.companyIdeology4, lang)}
            </p>
          </div>
        </div>
      </div>
